...
public class ChatFragment extends Fragment {
    ...
    private String id, massage, name, Id, img, show_userid;
    private long time;
...
//                                    });
//                                }
//                                usal.add(new alldataclass(massage,show_userid, time));
//
...
////                                    }
////                                });
//                                Toast.makeText(context, ""+usal, Toast.LENGTH_SHORT).show();
//
//
//                                    holder.email.setText(usal.get(position).getMassage());
//
//
//
//                            }
