...
public class CallScreen extends AppCompatActivity {
	...
	AppCompatImageButton speaker, mute;
	...
	private class SinchCallListener implements CallListener {
		...
		public void onCallEstablished(Call establishedCall) {
			...
			if (audioManager.isMicrophoneMute()) {
				mute.setOnClickListener(v -> audioManager.setMicrophoneMute(true));
			} else
				mute.setOnClickListener(v -> audioManager.setMicrophoneMute(false));
		}
